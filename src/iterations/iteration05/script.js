...
// Theoretical RTP: 95.09% — calculated from the weighted symbol probabilities
// and the PAYOUT_TABLE multipliers below. See changes.md for full derivation.
const TARGET_RTP = 0.9509;
...
// Payout multipliers — tuned so theoretical RTP = 95.09% given SYMBOL_WEIGHTS.
// See changes.md for the full probability derivation and RTP breakdown.
const PAYOUT_TABLE = {
  DIAMOND_TRIPLE: 150,
  AGI_TRIPLE: 50,
  MONEY_TRIPLE: 40,
 ...
 *
 * Payout hierarchy (checked in order):
 *   1. Three-of-a-kind (rarest symbols pay most)
 *   2. Named combos (specific 3-symbol sets, any order)
 *   3. Two-of-a-kind (any pair returns 2.4× bet)
 *   4. No match (loss)
 *
